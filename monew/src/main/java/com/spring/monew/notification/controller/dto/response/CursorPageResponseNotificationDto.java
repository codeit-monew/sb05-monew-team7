...
public record CursorPageResponseNotificationDto(
    ...
    @Schema(
        description = "다음 페이지 커서. Base64('createdAt|id') 형식(정렬키: createdAt DESC, id DESC). URL-safe Base64 권장.",
        example = "MjAyNS0xMC0yM1QwNDoyMjoxNC40NjhafDcwZjM1YmQ5LTQxOTEtOGQxYS04YmM2LTEyMzQ1Njc4OWFiYw==",
        nullable = true
    )
    String nextCursor,

    @Schema(description = "서버가 사용한 after 기준시각", example = "2025-10-23T04:22:14.468Z", format = "date-time", nullable = true)
    Instant nextAfter,
