...
public record NotificationDto(
    ...
    @Schema(description = "생성 시각", format = "date-time", example = "2025-10-23T04:22:14.468Z")
    @JsonFormat(shape = JsonFormat.Shape.STRING, timezone = "UTC")
    Instant createdAt,

    @Schema(description = "수정 시각", format = "date-time", example = "2025-10-23T04:22:14.900Z", nullable = true)
    @JsonFormat(shape = JsonFormat.Shape.STRING, timezone = "UTC")
    Instant updatedAt,
    ...
    @Schema(description = "수신자 사용자 ID", format = "uuid", example = "3fa85f64-5717-4562-b3fc-2c963f66afa6")
    UUID userId,

    @Schema(description = "알림 내용(최대 255자)", example = "[관심사] 관련 기사가 3건 등록되었습니다.")
    String content,

    @Schema(description = "관련 리소스 타입", allowableValues = {"interest", "comment"}, example = "interest", nullable = true)
    String resourceType,
